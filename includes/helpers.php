<?php 
	...
	function conseguirEntradas($conexion, $limit = null, $categoria = null,$busqueda=null){
		$sql="SELECT e.*, c.nombre AS 'categoria' FROM entradas e ".
			 "INNER JOIN categorias c ON e.categoria_id = c.idcategorias ";
	...
	function conseguirEntrada($conexion, $id){
		$sql="SELECT e.* , c.nombre AS 'categoria', CONCAT(u.nombre, ' ', u.apellidos) AS usuario" 
			." FROM entradas e ".
			"INNER JOIN categorias c ON e.categoria_id=c.idcategorias ".
			"INNER JOIN usuarios u ON e.usuario_id=u.idusuarios ".
			"WHERE e.identradas=$id ";
	...
	function conseguirEntradas($conexion,$limit=null,$categoria=null){
		...
		if(!empty($categoria)){
			$sql=$sql."WHERE e.categoria_id = $categoria";
		}

		$sql=$sql."ORDER BY e.identradas DESC";
